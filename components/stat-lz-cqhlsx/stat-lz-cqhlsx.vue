	...
	<view>
		...
		<view class="uni-flex uni-row">
			<view class="flex-item">
				<view class="cqhlsx-ball ball-0">0</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-1">1</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-2">2</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-3">3</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-4">4</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-5">5</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-6">6</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-7">7</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-8">8</view>
			</view>
			<view class="flex-item has-left-border">
				<view class="cqhlsx-ball ball-9">9</view>
			</view>
		</view>
		<view class="uni-flex uni-row">
